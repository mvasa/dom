...
public class vpl
{
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    while(go){
      ...
      if( op == 3 ){////////////////////////////////////////////change this back later/////////////////
    	  a = mem[ip+1]; 
      ...
      if( op == 10 ){
       ...
       if(op == 25){////////////////////////////////done/////////////
    	 ...
    	 int sum = mem[bp + 2 + a] + mem[bp + 2 + b];
    	  mem[sum] = mem[bp + 2 + c];
    	  ip += 4;
      }
       if(op == 26){
    	  System.out.println("program halted successfully");
    	  go = false;
